...
public class GuardianTask  extends AsyncTask<String, Integer, List<Guardian>> {
    private static final String TAG = "GuardianTask";

    @Override
    protected List<Guardian> doInBackground(String... strings) {

        String urlString = Util.URL + "GuardianServlet";
        ...
        if (sb != null) {
            Gson gson = new Gson();
            Type listType = new TypeToken<List<Guardian>>() {
            }.getType();
